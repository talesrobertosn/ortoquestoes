...
export const CAMINHOS: Record<string, string> = {
  ...
  trofeu:
    'M8 3.5h8v5.5a4 4 0 0 1-8 0zM8 5.5H4.5V7A3.5 3.5 0 0 0 8 10.5M16 5.5h3.5V7a3.5 3.5 0 0 1-3.5 3.5M12 13v3.5M8.5 20.5h7M9.5 16.5h5v4h-5z',
  medalha:
    'M7.5 3h3l2.2 5.6M16.5 3h-3l-1.2 3M12 9.5a5.5 5.5 0 1 0 0 11 5.5 5.5 0 0 0 0-11zM12 12.5v5M10.5 13.6 12 12.5',
  bandeira: 'M5.5 21V4M5.5 4.5h11l-2.2 4 2.2 4h-11',
  lapis: 'M4 20h4L19 9a2.8 2.8 0 0 0-4-4L4 16zM13.5 6.5l4 4',
  relogio: 'M12 3.5a8.5 8.5 0 1 0 0 17 8.5 8.5 0 0 0 0-17zM12 7.5V12l3 2',
  alvo: 'M12 3.5a8.5 8.5 0 1 0 0 17 8.5 8.5 0 0 0 0-17zM12 8a4 4 0 1 0 0 8 4 4 0 0 0 0-8zM12 11.6v.8',
  'olho-riscado':
